...
background:
  linear-gradient(176deg,
    rgba(13,27,62,0.84) 0%,
    rgba(13,27,62,0.70) 45%,
    rgba(13,27,62,0.50) 72%,
    rgba(13,27,62,0.14) 100%   /* 아래쪽은 거의 덮지 않아 그림이 그대로 보인다 */
  ),
  url("./uploads/hero.jpg") 92% center / cover;
```
